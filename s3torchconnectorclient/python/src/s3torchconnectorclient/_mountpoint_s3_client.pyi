...
class GetObjectStream:
    ...
    def tell(self) -> int: ...
    def consume_into_buffer(self, buffer: SegmentedBuffer, start: int, end: int) -> int: ...
    def consume_multiple_ranges(self, ranges: List[Tuple[int, int]]) -> List[SegmentedBuffer]: ...
...
class SegmentedBuffer:
    ...
    def append_bytes(self, bytes_data: bytes) -> None: ...
